...
pub fn sprite_to_colliders(sprite_nb: usize, pos_x: f32, pos_y: f32) -> Option<Colliders> {
    match sprite_nb {
        ...
        TOP_RIGHT_WALL => {
            let top_collider = Collider::new(Point2D { x: pos_x, y: pos_y }, 32., -8.);
            let right_collider = Collider::new(
                Point2D {
                    x: pos_x + 24.,
                    y: pos_y,
                },
        ...
        BOTTOM_LEFT_WALL => {
            let bottom_collider = Collider::new(
                Point2D {
                    x: pos_x,
                    y: pos_y - 24.,
                },
        ...
        CANON_1_TO_LEFT => {
            let basement_collider = Collider::new(
                Point2D {
                    x: pos_x,
                    y: pos_y - 4.,
                },
            ...
            let canon_collider = Collider::new(
                Point2D {
                    x: pos_x + 14.,
                    y: pos_y - 14.,
                },
        ...
        | HORIZONTAL_PLASMA_3_B => {
            let door_collider = Collider::new(
                Point2D {
                    x: pos_x,
                    y: pos_y - 10.,
                },
        ...
        VERTICAL_PLASMA_0_A | VERTICAL_PLASMA_0_B | VERTICAL_PLASMA_1_A | VERTICAL_PLASMA_1_B
        | VERTICAL_PLASMA_2_A | VERTICAL_PLASMA_2_B | VERTICAL_PLASMA_3_A | VERTICAL_PLASMA_3_B => {
            let door_collider = Collider::new(
                Point2D {
                    x: pos_x + 14.,
                    y: pos_y,
        ...
        ITEM_PLATFORM => {
            let platform_collider = Collider::new(
                Point2D {
                    x: pos_x,
                    y: pos_y - 16.,
                },
        ...
        HORIZONTAL_PILLAR_MIDDLE
        | HORIZONTAL_PILLAR_CLOSURE_CLOSED
        | HORIZONTAL_PILLAR_CLOSURE_OPENING => {
            let tube = Collider::new(
                Point2D {
                    x: pos_x,
                    y: pos_y - 10.,
        ...
        VERTICAL_PILLAR_MIDDLE
        | VERTICAL_PILLAR_CLOSURE_CLOSED
        | VERTICAL_PILLAR_CLOSURE_OPENING => {
            let tube = Collider::new(
                Point2D {
                    x: pos_x + 10.,
                    y: pos_y,
...
pub fn init_bullet_collider(kind: &CanonKind, x: f32, y: f32) -> Colliders {
    match kind {
        ...
        _ => Colliders::from_vec(vec![Collider::new(
            Point2D {
                x: x + 14.,
                y: y - 16.,
            },
...
pub fn sprite_to_canon(sprite_nb: usize, x: usize, y: usize) -> Option<Canon> {
    match sprite_nb {
        CANON_1_TO_LEFT => Some(Canon {
            direction: Direction::Left,
            kind: CanonKind::Bullet,
            bullet_x_start: (x as f32 * TILE_SIZE) - 16.,
            bullet_y_start: (y as f32 * TILE_SIZE) - 2.,
        }),
        CANON_1_TO_RIGHT => Some(Canon {
            direction: Direction::Right,
            kind: CanonKind::Bullet,
            bullet_x_start: (x as f32 * TILE_SIZE) + 16.,
            bullet_y_start: (y as f32 * TILE_SIZE) - 2.,
        }),
        CANON_1_TO_TOP => Some(Canon {
            direction: Direction::Top,
            kind: CanonKind::Bullet,
            bullet_x_start: (x as f32 * TILE_SIZE),
            bullet_y_start: (y as f32 * TILE_SIZE),
        }),
        CANON_1_TO_BOTTOM => Some(Canon {
            direction: Direction::Bottom,
            kind: CanonKind::Bullet,
            bullet_x_start: (x as f32 * TILE_SIZE),
            bullet_y_start: (y as f32 * TILE_SIZE),
        }),
        CANON_2_TO_LEFT => Some(Canon {
            direction: Direction::Left,
            kind: CanonKind::Smg,
            bullet_x_start: (x as f32 * TILE_SIZE) - 16.,
            bullet_y_start: (y as f32 * TILE_SIZE) - 1.,
        }),
        CANON_2_TO_RIGHT => Some(Canon {
            direction: Direction::Right,
            kind: CanonKind::Smg,
            bullet_x_start: (x as f32 * TILE_SIZE) + 16.,
            bullet_y_start: (y as f32 * TILE_SIZE) - 1.,
        }),
        CANON_2_TO_TOP => Some(Canon {
            direction: Direction::Top,
            kind: CanonKind::Smg,
            bullet_x_start: (x as f32 * TILE_SIZE),
            bullet_y_start: (y as f32 * TILE_SIZE) - 1.,
        }),
        CANON_2_TO_BOTTOM => Some(Canon {
            direction: Direction::Bottom,
            kind: CanonKind::Smg,
            bullet_x_start: (x as f32 * TILE_SIZE),
            bullet_y_start: (y as f32 * TILE_SIZE) - 1.,
        }),
        CANON_3_TO_LEFT => Some(Canon {
            direction: Direction::Left,
            kind: CanonKind::Air,
            bullet_x_start: (x as f32 * TILE_SIZE) - 16.,
            bullet_y_start: (y as f32 * TILE_SIZE) - 1.,
        }),
        CANON_3_TO_RIGHT => Some(Canon {
            direction: Direction::Right,
            kind: CanonKind::Air,
            bullet_x_start: (x as f32 * TILE_SIZE) + 16.,
            bullet_y_start: (y as f32 * TILE_SIZE) - 1.,
